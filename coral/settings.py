...
SECRET_KEY = 'd=&y&af&%y#bqi5qvxz-q3fs(6$qb#d+5(u03mtfq5v8cjy1l9'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'context_processors': [
                ...
                'coral.context_processors.records'
            ],
            'loaders': LOADERS
        },
    },
...
DEFAULT_DOMAIN = 'http://coral.com/'


# ========== PROJECT ==========
OPAL_BRAND_NAME = 'Coral'
